...
Full Stack Developer with experience building and deploying production-ready web applications. I handle everything from database design to frontend implementation to deployment. Committed to writing clean, maintainable code and delivering end-to-end solutions that solve real business problems.
